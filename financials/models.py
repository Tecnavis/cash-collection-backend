...
class Transaction(models.Model):
    ...
    scheme = models.ForeignKey('collectionplans.CashCollectionScheme', on_delete=models.CASCADE, related_name="transactions")
    ...
    # refund = models.ForeignKey('collectionplans.Refund', on_delete=models.SET_NULL, null=True, related_name="transactions")
    refund = models.ForeignKey(Refund, on_delete=models.CASCADE, null=True, blank=True)
    scheme = models.ForeignKey(CashCollectionScheme, on_delete=models.CASCADE, null=True, blank=True)
...
class TransactionReconciliation(models.Model):
    transaction = models.OneToOneField('financials.Transaction', on_delete=models.CASCADE, related_name="reconciliation")
    reconciled_by = models.ForeignKey('users.CustomUser', on_delete=models.SET_NULL, null=True, related_name="reconciled_transactions")
